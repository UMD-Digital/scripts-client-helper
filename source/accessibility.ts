type AttachFocusParams = {
  element: HTMLElement;
  action: (arg: KeyboardEvent) => void;
};

export type AttachFocusType = (arg: AttachFocusParams) => () => void;
export type AttachEventsType = () => void | undefined;

export const attachFocus: AttachFocusType = ({ element, action }) => {
